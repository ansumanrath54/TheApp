...
import 'package:social_media_app_starter/chat_app/components/chat.dart';
import 'package:social_media_app_starter/chat_app/models/chat_users.dart';
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          SizedBox(width: 2,),
                          Text("UpBuzz",style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold),),
                        ],
                      ),
                    )
                  ],
